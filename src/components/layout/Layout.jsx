...
const Layout = ({children}) => {
    ...
    <>
          ...
          <div className='flex'>
          <Sidebar>
              <SidebarItem text={t('Home')}  icon={<LayoutDashboard />} active={path=='/dashboard'} link='/dashboard'/>
              ...
              <SidebarItem text={t('aiTutor')}  icon={<Brain />} active={path=='/all-courses'} link='all-courses' />
