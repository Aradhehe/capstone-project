  ...
  <section className='bg-gradient-to-r from-purple-800 to-indigo-800 pb-[50px] py-16'>
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      ...
      <footer className='flex bg-gradient-to-r from-[#f600fe] via-[#a136ff] to-[#0033d9] text-white justify-center mt-16'>
        ...
        <div className="flex flex-col gap-2 text-start">
            ...
            {/* <p className="text-[20px] font-medium cursor-pointer">Learning path generator</p> */}
            <p className="text-[20px] font-medium cursor-pointer">Multi-lingual Support</p>
            <p className="text-[20px] font-medium cursor-pointer">Course Worthiness</p>
    ...
    <div className="p-2">
        ...
        <div className='flex flex-col gap-2 mt-8'>
            <label htmlFor="email" className="text-[20px]">Email address</label>
            <input type="text" name="email" className="bg-transparent border-2 p-2 px-4 w-[327px]" placeholder="Eg: johndoe@gmail.com"/>
            <p className="text-[14px] w-[327px] mt-2">Get regular updates and stay in touch as we share the latest developments on our AI Ed-Tech Platform.</p>
        </div>  
        </div>
    </div> 
  </footer>
